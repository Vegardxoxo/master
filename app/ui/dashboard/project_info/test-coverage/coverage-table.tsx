  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden h-full flex flex-col">
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">File Coverage Details</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400">{fileData.length} files analyzed</p>
      </div>
