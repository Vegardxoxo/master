...
export function DashboardNavigation({ onToggle, onToggleSubsection, visibleSections }: SidebarProps) {
              ...
              subKey !== "visible" && (
                <li key={subKey}>
                  <div
                    ...
                    className="w-full flex items-center justify-between px-3 py-1 text-xs font-medium text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-150 ease-in-out rounded-md pl-8 cursor-pointer"
                  >
  ...
  return (
    <Card className="sticky top-4 w-full lg:w-64 bg-white shadow-md">
      <CardHeader className="pb-4">
        <CardTitle className="text-lg font-semibold text-blue-600">Dashboard Controls</CardTitle>
      </CardHeader>
          ...
          {Object.entries(visibleSections).map(([key, value]) => (
            <li key={key}>
              <div
                ...
                className="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-150 ease-in-out rounded-md cursor-pointer"
              >
