...
export default function CommitContributionsTable({ data }: { data: any }) {
      ...
      <Table>
        ...
        <TableBody className={"font-semibold"}>
          ...
          <TableRow>
            ...
            <TableCell className={`px-4 py-2 ${isHighAverageChanges ? "bg-green-100 text-green-700" : ""}`}>
          ...
          <TableRow>
            ...
            <TableCell
                className={`px-4 py-2 ${isHighAddDelRatio ? "bg-blue-100 text-blue-700" : "bg-red-100 text-red-700"}`}
            >
              {data.additions_deletions_ratio.toFixed(2)}
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Average files changed per commit</TableCell>
