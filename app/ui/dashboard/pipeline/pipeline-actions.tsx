    ...
    <Card className="w-full h-full">
      <CardHeader>
        ...
        <CardDescription className="text-sm text-gray-500">
          {runs.total_count} total runs - Latest: {latestRun ? new Date(latestRun.created_at).toLocaleDateString() : 'N/A'}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Number of workflow runs that completed successfully and their percentage of the total runs.</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Average time between a failed run and the next successful run. Measures how quickly issues are resolved.</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center space-x-2 cursor-help">
                  ...
                  <span className="text-sm font-medium text-gray-700">
                    Latest Status: {latestRun ? (latestRun.conclusion || latestRun.status) : 'N/A'}
                  </span>
                </div>
              </TooltipTrigger>
              <TooltipContent>
                <p>Status of the most recent workflow run across all actions.</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
