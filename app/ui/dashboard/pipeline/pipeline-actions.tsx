        ...
        <Card className="w-full h-full">
            <CardHeader>
                ...
                <CardDescription className="text-sm text-gray-500">
                    {runs.total_count} total runs -
                    Latest: {latestRun ? new Date(latestRun.created_at).toLocaleDateString() : 'N/A'}
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="grid grid-cols-2 gap-4">
                    ...
                    {successfulRuns} Successful ({successRate}%)
                            ...
                            <TooltipContent>
                                <p>Number of workflow runs that completed successfully and their percentage of the total
                                    runs.</p>
                            </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                    ...
                    Avg Recovery: {formatTime(averageRecoveryTime)}
                            ...
                            <TooltipContent>
                                <p>Average time between a failed run and the next successful run. Measures how quickly
