                ...
                <CardContent className={"space-y-2"}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <Card className="overflow-hidden border-0 shadow-md">
                            <CardHeader
                                className="flex flex-row items-center justify-between space-y-0 pb-2 border-b border-blue-200/50">
                        ...
                        <Card className="overflow-hidden border-0 shadow-md">
                            <CardHeader
                                className="flex flex-row items-center justify-between space-y-0 pb-2 border-b border-purple-200/50">
