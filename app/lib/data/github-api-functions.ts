...
import {Commit, CommitData, GithubRepoOverview, PullRequestData,} from "@/app/lib/definitions/definitions";
...
async function loadImages(
    imagePaths: string[]
): Promise<Array<{ originalPath: string; base64: string; uniqueName: string }>> {
    const results: Array<{
        originalPath: string;
        base64: string;
        uniqueName: string;
